 ...
 * - When `category` is undefined or 'all', returns all 5 categories.
 ...
 * @param category - Optional category filter ('feeding' | 'sleep' | 'diaper_digestion' | 'crying_soothing' | 'mom_wellbeing')
