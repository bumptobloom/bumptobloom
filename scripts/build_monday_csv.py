...
T = [
    ...
    (1, "Scaffold the Ask module and wire an /api/ask route stub", "Mohd Shaff Had Khan", "Pod I", "High",
     "Route exists and returns a stub this week. Ask lives inside the web app - no second service (ADR-001)."),
    ...
    (2, "Design Ask prompt architecture and baby-context builder", "Keya Chaudhari", "Pod W", "High",
     "Age in months only. No name, no user id, nothing identifying reaches OpenAI."),
    ...
    (4, "Ask: conversation persistence and /api/ask handler", "Tarigopula Sivathmika Chowdary", "Pod I", "High",
    ...
    (6, "Ask load test and cost projection at beta scale", "Mohd Shaff Had Khan", "Pod I", "Medium",
     "We need a per-user cost number before anyone talks about scaling this."),
    # ---- PM-owned work with long lead times ----
    (1, "Apply to Amazon Associates, Target and Walmart affiliate programs", "Jasdeep Singh", "Product", "Critical",
     "Approval takes 1-3 weeks and Cart ships in week 4. If this is not started in week 1 the Cart tab launches with dead links and no revenue path. Nothing engineering does can shorten this."),
