...
T = [
    ...
    (4, "Recommended for You: product list and product detail screens", "Melvin James Bryant III", "Pod E", "High",
     "RENAMED from Cart. Cart is no longer a tab - Product confirmed 1 Sep. Entry is a Recommended for You card on Home, which opens a product list for the baby's age, and tapping a product opens a detail screen showing why it is recommended plus a Shop now button out to a third-party retailer. No checkout, no basket, no total. CORRECTED 18 Sep: this used to ask for a 'we only link to trusted retailers' line on the list. That is from the pre-redesign Figma and is in no version of the PRD - Melvin caught it reviewing #211. Use the PRD copy verbatim: the US-009 list disclaimer, and on the detail both the US-010 info message and the bottom disclaimer. Full wording is in the task detail entry."),
