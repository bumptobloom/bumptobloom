...
T = [
    ...
    (1, "Finish repo setup: sync develop with main, verify CODEOWNERS", "Sonakshi Panda", "Pod W", "High",
     "Org, repo and the branch ruleset are done as of 29 Aug: main and develop both need 1 review and three green checks. CODEOWNERS now carries real handles. What is left is that develop is behind main, and every handle needs re-checking as people accept their invites."),
    ...
    (3, "Wire the fever engine into the app and log results", "Sonakshi Panda", "Pod W", "Critical",
    ...
    (5, "Three fever result screens, severity high-to-low", "Melvin James Bryant III", "Pod E", "Critical",
