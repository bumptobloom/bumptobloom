...
"Recommended for You: product list and product detail screens": {
 "do": ["Entry point is the Recommended for You card on Home, not a tab. Cart stopped being a tab on 1 Sep.",
        ...
        "CORRECTED 18 Sep - this used to say to keep a 'we only link to trusted retailers' line on the list. That line is from the pre-redesign Figma and appears nowhere in the current PRD. Melvin flagged it in review of #211 and he was right. Use the PRD copy verbatim instead:",
        "LIST (US-009): 'Products chosen with your child in mind. Please review age recommendations, safety information, and product details before purchasing.'",
        "DETAIL, under 'Why it's helpful at N months' (US-010): 'Product recommendation are general suggestions and do not replace professional medical device'. The PRD says 'medical device' where it almost certainly means 'medical advice' - raised with Product 18 Sep, use as written until they confirm.",
        "DETAIL, bottom of page (US-010): 'Products chosen with your child in mind. BumpToBloom does not manufacture, inspect, or guarantee any third-party product. Please check the product's age and safety information before purchasing. We may earn a small commission at no extra cost to you.'",
