...
on conflict (id) do update set
  ...
  -- A card in this snapshot is by definition live. Without this line a card
  -- unpublished by an earlier run would be updated but stay hidden.
  published = excluded.published;


-- Unpublish, never delete. See the header.
update content
set published = false
where published
  and id <> all (array[
  ...
  'c0000001-0000-4000-8000-000000000010'::uuid,
  'c0000001-0000-4000-8000-000000000011'::uuid,
  'c0000001-0000-4000-8000-000000000012'::uuid,
  'c0000001-0000-4000-8000-000000000013'::uuid,
  'c0000001-0000-4000-8000-000000000014'::uuid,
  'c0000001-0000-4000-8000-000000000015'::uuid,
  'c0000001-0000-4000-8000-000000000016'::uuid,
  'c0000001-0000-4000-8000-000000000017'::uuid,
  'c0000001-0000-4000-8000-000000000018'::uuid,
  'c0000001-0000-4000-8000-000000000019'::uuid,
  'c0000001-0000-4000-8000-000000000020'::uuid,
  'c0000001-0000-4000-8000-000000000021'::uuid,
  'c0000001-0000-4000-8000-000000000022'::uuid,
  'c0000001-0000-4000-8000-000000000023'::uuid,
  'c0000001-0000-4000-8000-000000000024'::uuid,
  'c0000001-0000-4000-8000-000000000025'::uuid,
  'c0000001-0000-4000-8000-000000000026'::uuid,
  'c0000001-0000-4000-8000-000000000027'::uuid,
  'c0000001-0000-4000-8000-000000000028'::uuid,
  'c0000001-0000-4000-8000-000000000029'::uuid,
  'c0000001-0000-4000-8000-000000000030'::uuid,
  'c0000001-0000-4000-8000-000000000031'::uuid,
  'c0000001-0000-4000-8000-000000000032'::uuid,
  'c0000001-0000-4000-8000-000000000033'::uuid,
  'c0000001-0000-4000-8000-000000000034'::uuid,
  'c0000001-0000-4000-8000-000000000035'::uuid,
  'c0000001-0000-4000-8000-000000000036'::uuid,
  'c0000001-0000-4000-8000-000000000037'::uuid,
  'c0000001-0000-4000-8000-000000000038'::uuid,
